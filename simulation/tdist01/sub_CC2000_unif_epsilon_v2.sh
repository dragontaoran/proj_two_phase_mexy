...
echo "#SBATCH --output=CC2000_unif_epsilon_v2.slog  # output and error messages go to this file" >> tmp.slurm
...
echo "" >> tmp.slurm
echo "Rscript sim_CC2000_unif_epsilon_v2.R ${dir}" >> tmp.slurm
